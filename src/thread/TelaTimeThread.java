...
public class TelaTimeThread extends JDialog{
	...
	public TelaTimeThread() {/*Executa o que estiver dentro no momento da abertura ou execução / estanciar o objeto*/
		...
		setVisible(true);/*Ultimo comando a ser executado, torna a tela visivel para o usuário*/
